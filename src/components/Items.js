...
const Items = ({ items, fetchItems }) => {
  ...
  const dsplyItems = items.slice(pagesVisited, pagesVisited + itemsPerPage).map((item) => (
  ...
  return (
    <section className="container-fluid mt-4">
      ...
      <ReactPaginate
        ...
        containerClassName="main-class d-flex flex-wrap justify-content-center align-items-center"
